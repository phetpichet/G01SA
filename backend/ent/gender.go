...
func (e GenderEdges) UsersOrErr() ([]*User, error) {
	if e.loadedTypes[0] {
		return e.Users, nil
	}
...
// QueryUsers queries the users edge of the Gender.
func (ge *Gender) QueryUsers() *UserQuery {
	return (&GenderClient{config: ge.config}).QueryUsers(ge)
}
