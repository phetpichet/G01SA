...
func (e TitleEdges) UsersOrErr() ([]*User, error) {
	if e.loadedTypes[0] {
		return e.Users, nil
	}
...
// QueryUsers queries the users edge of the Title.
func (t *Title) QueryUsers() *UserQuery {
	return (&TitleClient{config: t.config}).QueryUsers(t)
}
